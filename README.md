...
Internal operations dashboard for AD Group's Showcase product. Deployed at `dashboard.showcase.space`.

**Stack:** Next.js 16 · TypeScript · Tailwind CSS · Express · PostgreSQL (AWS RDS)
